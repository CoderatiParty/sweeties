    ...
    def handle_payment_intent_succeeded(self, event):
        ...
        if username != 'AnonymousUser':
            ...
            if save_info:
                ...
                profile.post_or_zipcode = shipping_details.address.postal_code
        ...
        while attempt <= 5:
            try:
                order = Order.objects.get(
                    first_name__iexact=shipping_details.name.first,
                    last_name__iexact=shipping_details.name.last,
